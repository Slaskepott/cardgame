...
TALENT_DEFINITIONS = [
    ...
    },
    {
        ...
        "description": "+9% max health and +8% Earth draw chance per rank.",
        "cost": 1,
        "max_ranks": 2,
        "requires": ["defense_stone_lungs"],
        "row": 2,
        "column": 1,
        "bonuses": {"health_pct": 9, "earth_draw_pct": 8},
    },
    {
    ...
    },
    {
        ...
        "cost": 1,
        "max_ranks": 1,
        "requires": ["utility_loaded_dice", "utility_wild_script", "utility_crown_hustle"],
        "row": 4,
        "column": 2,
        "bonuses": {
            "hand_size_flat": 1,
