...
ACHIEVEMENT_DEFINITIONS = [
    ...
    {"id": "full_hand_kind_1", "name": "Rigged Looking Opening", "description": "Draw a full hand of one rank.", "stat": "full_hand_of_a_kind_draws", "target": 1},
    {"id": "full_hand_kind_5", "name": "Eight Of A Kind, Sure", "description": "Draw 5 full hands of one rank.", "stat": "full_hand_of_a_kind_draws", "target": 5},
...
TALENT_DEFINITIONS = [
    ...
    },
    {
        ...
        "specialization": "offense",
        "name": "Killing Rhythm",
        "description": "+4% high card damage and +6% high card draw chance.",
        "cost": 1,
    ...
    },
    {
        ...
        "specialization": "offense",
        "name": "Primal Weight",
        "description": "+4% low card damage and +6% low card draw chance.",
        "cost": 1,
    ...
    },
    {
        ...
        "specialization": "offense",
        "name": "Cataclysm",
        "description": "+8% overall damage, +2% to all elemental damage, and +10% Q/K/A draw chance.",
        "cost": 3,
    ...
    },
    {
        ...
        "specialization": "defense",
        "name": "Brace",
        "description": "-2% incoming damage and +5% Water draw chance.",
        "cost": 1,
    ...
    },
    {
        ...
        "specialization": "defense",
        "name": "Long Breath",
        "description": "+1 discard each round and +8% 2/3 draw chance.",
        "cost": 1,
        "requires": ["defense_root"],
        "row": 1,
        "column": 2,
        "bonuses": {"max_discards_flat": 1, "tiny_draw_pct": 8},
    },
    {
        "id": "defense_warden",
        "specialization": "defense",
        "name": "Warden's Posture",
        "description": "+6% max health and +5% Earth draw chance.",
        "cost": 1,
    ...
    },
    {
        ...
        "specialization": "defense",
        "name": "Stalwart Core",
        "description": "-3% incoming damage and +6% low card draw chance.",
        "cost": 1,
        "requires": ["defense_long_breath"],
        "row": 2,
        "column": 2,
        "bonuses": {"damage_taken_pct": -3, "low_card_draw_pct": 6},
    },
    {
        "id": "defense_capstone",
        "specialization": "defense",
        "name": "Unbreakable",
        "description": "+10% max health, -5% incoming damage, and +12% 2/3 draw chance.",
        "cost": 3,
        "requires": ["defense_warden", "defense_stalwart"],
        "row": 3,
        "column": 1,
        "bonuses": {"health_pct": 10, "damage_taken_pct": -5, "tiny_draw_pct": 12},
    },
    {
        "id": "utility_root",
        "specialization": "utility",
        "name": "Quick Fingers",
        "description": "+1 discard each round and +6% Air draw chance.",
        "cost": 1,
        "requires": [],
        "row": 0,
        "column": 1,
        "bonuses": {"max_discards_flat": 1, "air_draw_pct": 6},
    },
    {
        "id": "utility_tempest",
        "specialization": "utility",
        "name": "Tempest Instinct",
        "description": "+3% Air damage and +8% Air draw chance.",
        "cost": 1,
    ...
    },
    {
        ...
        "specialization": "utility",
        "name": "Tide Memory",
        "description": "+3% Water damage and +8% Water draw chance.",
        "cost": 1,
        "requires": ["utility_root"],
        "row": 1,
        "column": 2,
    ...
    },
    {
        ...
        "specialization": "utility",
        "name": "Smooth Draw",
        "description": "+4% low card damage and +8% low card draw chance.",
        "cost": 1,
    ...
    },
    {
        ...
        "specialization": "utility",
        "name": "Clever Finish",
        "description": "+4% high card damage and +8% high card draw chance.",
        "cost": 1,
    ...
    },
    {
        ...
        "specialization": "utility",
        "name": "Loaded Dice",
        "description": "+1 discard, +4% to all elemental damage, and +12% Q/K/A draw chance.",
        "cost": 3,
